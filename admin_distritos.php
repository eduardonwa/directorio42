...
<body>
        ...
        <div class="admin-panel-header">
            <h1> Administrador de distritos </h1>
        </div>

        <div class="action-control">
           
           <div class="actions-box">
               <img class="actions-panel-icon" src="img/icons/distritos-icon.svg">
               <p><a href="add_distrito.php">Agregar una nueva sede de distrito</a></p>
           </div>
           
           <div class="actions-box">
               <img class="actions-panel-icon" src="img/icons/consult-icon.svg">
               <p><a href="admin_panel_distritos.php">Consultar y editar</a></p>
           </div>
